...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\PycharmProjects\graduate_work\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\PycharmProjects\graduate_work\venv\Scripts\deactivate.nu'
